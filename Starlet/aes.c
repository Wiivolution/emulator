...
#define AES_EXEC_FLAG 0x80000000
#define AES_IRQ_FLAG  0x40000000
#define AES_ERR_FLAG  0x20000000
#define AES_ENA_FLAG  0x10000000
#define AES_DEC_FLAG  0x08000000
#define AES_IV_FLAG   0x00001000
...
uint8_t FIFO_IV_written = 0;
uint8_t FIFO_KEY_written = 0;
